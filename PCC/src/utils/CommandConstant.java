...
public class CommandConstant {
	 ...
	 * 空调控制
	 */
	public static final String AIR_POWER_ON = "AirOn";
	public static final String AIR_POWER_OFF = "AirOff";
	public static final String AIR_TEMP_UP = "TempUp";
	public static final String AIR_TEMP_DOWN = "TempDown";
	/**
	 * 图片控制模式
	 */
